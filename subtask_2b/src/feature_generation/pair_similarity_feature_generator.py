...
from src.feature_generation.file_paths.pp2_files import sbert_encodings_training_pp2, sbert_sims_training_pp2, \
    ...
    main_syms_token_ratio_sims_test_pp2, main_syms_token_ratio_sims_test_pp2_tsv, main_syms_ratio_sims_training_pp2, \
    main_syms_ratio_sims_training_pp2_tsv, main_syms_ratio_sims_test_pp2, main_syms_ratio_sims_test_pp2_tsv, \
    words_token_ratio_sims_test_pp2_tsv, words_token_ratio_sims_test_pp2, words_token_ratio_sims_training_pp2, \
    words_token_ratio_sims_training_pp2_tsv, words_ratio_sims_training_pp2, words_ratio_sims_training_pp2_tsv, \
    words_ratio_sims_test_pp2_tsv, words_ratio_sims_test_pp2
