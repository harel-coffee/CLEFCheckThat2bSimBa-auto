...
class DataNamedEntityDisambiguator:
    ...
    @staticmethod
    def disambiguate_named_entities(input_file, output_file, vclaim_key='vclaim'):
        ...
        if os.path.isfile(input_file):
            ...
            for json_file in os.listdir(input_file):
                ...
                list_of_named_entity_lists.append(entity_fisher.get_named_entities_of_sentence(v_claim[vclaim_key]))
