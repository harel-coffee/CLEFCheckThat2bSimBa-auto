...
class DataSyntacticInfoFinder:
    ...
    def find_all_syntact_info(self, input_file, output_file, vclaim_key='vclaim'):
        if self.type == DataSyntacticInfoFinderType.subjects.name:
            if os.path.isfile(input_file):
                ...
                for json_file in os.listdir(input_file):
                    ...
                    list_of_syntactic_elements.append(PartOfSpeechEvaluator.get_subject_of_sentence(v_claim[vclaim_key]))
