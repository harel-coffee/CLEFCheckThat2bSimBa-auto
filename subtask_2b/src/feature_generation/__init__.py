...
v_claims_directory = 'data/politifact-vclaims'
v_claims_df = 'data/vclaims_df.pkl'
training_data_general = 'data/original_speech_data/training_data/CT2022-Task2B-EN-Train-Dev_Queries.tsv'
labels_general = 'data/original_speech_data/training_data/all_train.pkl'


test_data_pp1 = 'data/original_speech_data/test_data/queries.tsv'
